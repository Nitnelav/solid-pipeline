...
def execute(context):
    ...
    codes_file = "%s/%s" % (context.path("data.spatial.download.codes"), context.stage("data.spatial.download.codes"))
    ...
    df_codes["municipality_id"] = df_codes["municipality_id"].cat.remove_unused_categories()
