...
def execute(context):
    ...
    with context.progress(
        label="Downloading GeolocalisationEtablissement_Sirene_pour_etudes_statistiques_utf8 ...",
        minimum_interval=5,
    ) as progress:
        ...
        urllib.request.urlretrieve(
            url,
            "%s/GeolocalisationEtablissement_Sirene_pour_etudes_statistiques_utf8.zip"
            % context.path(),
